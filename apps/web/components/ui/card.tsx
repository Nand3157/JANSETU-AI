...
export function CardTitle({ className, children, as = "h3" }: React.HTMLAttributes<HTMLHeadingElement> & { as?: "h2" | "h3" | "h4" }) {
  const Tag = as;
  return <Tag className={cn("text-[15px] font-semibold tracking-tight text-[#172033]", className)}>{children}</Tag>;
}
