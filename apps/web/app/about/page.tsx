...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-[720px] px-4 md:px-6 py-12">
      ...
      <p className="text-[#5F6368] mt-3 leading-relaxed text-sm">
      ...
      <div className="mt-8 rounded-[20px] bg-white border border-[#E5E7EB] p-6 text-sm leading-relaxed text-[#5F6368]">
      ...
      <div className="mt-6 rounded-[20px] bg-white border border-[#E5E7EB] p-6 text-sm leading-relaxed text-[#172033]">
