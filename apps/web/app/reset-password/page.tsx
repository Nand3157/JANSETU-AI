        ...
        {sent ? (
          <div role="status" aria-live="polite" className="mt-6 space-y-4">
            <div className="flex items-start gap-2 rounded-2xl border border-[#CEE6D0] bg-[#E6F4EA] px-4 py-3 text-sm text-[#188038]">
              <CheckCircle2 className="h-4 w-4 mt-0.5 shrink-0" /> If that email is registered, a reset link is on its way.
            </div>
          ...
          <form onSubmit={submit} noValidate className="mt-6 space-y-4">
            ...
            <Button type="submit" className="w-full rounded-full h-11"><Mail className="h-4 w-4" /> Send reset link</Button>
