...
export default function HowItWorks() {
  return (
    <div className="mx-auto max-w-[880px] px-4 md:px-6 py-12">
      ...
      <p className="text-[#5F6368] mt-2">Six steps from voice to measurable impact.</p>
      <div className="mt-8 grid gap-4">
        {[
          ...
          <div key={t} className="rounded-[20px] bg-white border border-[#E5E7EB] p-5 flex gap-4">
            ...
            <div><div className="font-medium">{t.slice(3)}</div><div className="text-sm text-[#5F6368]">{d}</div></div>
          </div>
        ))}
      </div>
    </div>
