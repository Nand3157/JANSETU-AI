    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#5F6368]">Google Maps-style · heatmaps · clustered markers · accessible</p>
        </div>
      ...
      <div className="grid lg:grid-cols-[1.6fr_0.9fr] gap-4">
        ...
        {demoCluster ? (
          <div className="rounded-[20px] bg-white border border-[#E5E7EB] p-5 shadow-card sticky top-[80px] h-fit">
            <div className="text-[11px] tracking-widest font-semibold text-[#5F6368]">DABHOI RURAL CLUSTER</div>
            <h3 className="font-semibold leading-tight mt-1">{demoCluster.title || "Dabhoi Rural Cluster"}</h3>
            <div className="mt-3 flex items-center gap-2">
              <span className="h-10 w-10 rounded-xl bg-[#0B1F3A] text-white grid place-items-center font-bold text-sm">{Math.round(demoCluster.priorityScore||92)}</span>
              <div><div className="text-xs text-[#5F6368]">Priority</div><div className="font-semibold">92 / 100</div></div>
              <Badge tone="high" className="ml-auto">High</Badge>
            </div>
            <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
              <div className="rounded-xl bg-[#F8FAFC] border border-[#E5E7EB] p-3"><div className="text-lg font-semibold">3,842</div><div className="text-xs text-[#5F6368]">requests</div></div>
              <div className="rounded-xl bg-[#F8FAFC] border border-[#E5E7EB] p-3"><div className="text-lg font-semibold">18,240</div><div className="text-xs text-[#5F6368]">people affected</div></div>
              <div className="rounded-xl bg-white border border-[#E5E7EB] p-3"><div className="text-sm font-medium">Road Infrastructure</div><div className="text-lg font-semibold">38 <span className="text-sm font-normal text-[#5F6368]">/100</span></div></div>
              <div className="rounded-xl bg-white border border-[#E5E7EB] p-3"><div className="text-sm font-medium">Healthcare Access</div><div className="text-lg font-semibold">42 <span className="text-sm font-normal text-[#5F6368]">/100</span></div></div>
            </div>
            <div className="mt-3 rounded-xl bg-[#FEF3C7] border border-[#FDE68A] p-3 flex items-center justify-between">
              <div><div className="text-xs text-[#92400E]">Investment Gap</div><div className="font-semibold">₹5.6 Cr</div></div>
              <MapPin className="h-4 w-4 text-[#92400E]" />
            </div>
            <Button className="w-full mt-4 rounded-full">View Analysis</Button>
            <div className="text-[11px] text-[#5F6368] mt-2">Heatmaps · clustered markers · accessible markers not color-only</div>
          </div>
        ) : (
